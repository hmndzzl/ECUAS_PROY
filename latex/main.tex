...
\usepackage{pdfpages} % Para insertar los PDFs de GoodNotes y Bitácora
\usepackage[style=apa, backend=biber]{biblatex}

% --- CONFIGURACIÓN DE RUTAS Y BIBLIOGRAFÍA ---
\graphicspath{{figs/}} % Define la carpeta donde busca las imágenes
...
\begin{titlepage}
    ...
    \par 
    \small Video de Youtube, Presentación: \url{https://github.com/hmndzzl/ECUAS_PROY.git}
\end{titlepage}
...
# (El resto del código ha sido omitido por brevedad en el documento impreso, 
# pero está disponible completo en el repositorio GitHub).
\end{lstlisting}
